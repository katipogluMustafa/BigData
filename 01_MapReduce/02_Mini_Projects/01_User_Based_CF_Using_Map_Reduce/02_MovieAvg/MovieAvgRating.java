...
public class MovieAvgRating extends Configured implements Tool {
    ...
    public static class AvgMapper extends Mapper<LongWritable, Text, IntWritable, DoubleWritable>{
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            context.write(new IntWritable(Integer.parseInt(inputLine[1])),
    ...
    public static class AvgReducer extends Reducer<IntWritable, DoubleWritable, IntWritable, DoubleWritable>{
        @Override
        protected void reduce(IntWritable movieId, Iterable<DoubleWritable> ratings, Context context) throws IOException, InterruptedException {
            int count = 0;
            double sum = 0;
    ...
    public int run(String[] args) throws Exception {
        ...
        String oPath = "hdfs://master:9000/user/herolenk/outputs/movieAvgRating";
        ...
        job.setJarByClass(MovieAvgRating.class);
    ...
    public static void main(String[] args) {
        ...
        try{
            errCode = ToolRunner.run(new Configuration(), new MovieAvgRating(), args);
        }catch (Exception e){
            e.printStackTrace();
        }
        System.exit(errCode);
